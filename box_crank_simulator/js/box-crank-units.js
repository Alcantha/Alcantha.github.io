...
function initListUnit() {
  ...
  units[59] = { name: 'Jupiter King', rarity: 3, type: 1 };
  ...
  units[97] = { name: 'Vanguard', rarity: 3, type: 1 };
  ...
  units[159] = { name: 'El Dorado', rarity: 3, type: 1 };
  units[164] = { name: 'Professor', rarity: 3, type: 1 };
  units[167] = { name: 'Dragunov', rarity: 3, type: 1 };
  ...
  units[278] = { name: 'Annette', rarity: 3, type: 1 };
  ...
  units[531] = { name: 'Gemini White & Black', rarity: 3, type: 2 };
}
